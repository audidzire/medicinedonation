...
ENGINE_NAME, NAME, VERSION, PLATFORM, ENGINE_VERSION, ENGINE_CSS_GRADE = list(range(6))
...
class DatatablesTestMixin(object):
    ...
    def test_unpaginated(self):
        ...
        browsers = [BrowserFactory() for _ in range(5)]
    ...
    def test_paginated(self):
        ...
        browsers = [BrowserFactory() for _ in range(15)]
